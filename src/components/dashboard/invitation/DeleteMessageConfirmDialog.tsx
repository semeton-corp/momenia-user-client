...
type DeleteMessageConfirmDialogProps = {
  open: boolean
...
export function DeleteMessageConfirmDialog({
  ...
  const t = useTranslations("dashboard.workspace.messages.deleteDialog")
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogDescription className="mt-2 text-center text-sm font-normal text-[#000000]">
          {senderName ? t("descriptionNamed", { name: senderName }) : t("description")}
        </DialogDescription>
